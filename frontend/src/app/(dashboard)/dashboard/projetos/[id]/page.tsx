    ...
    Promise.all([
      ...
      .then(([p, c]) => {
        ...
        setForm({
          ...
          data_fim: p.data_fim || "",
          valor_orcado: p.valor_orcado != null ? String(p.valor_orcado) : "",
          valor_realizado: p.valor_realizado != null ? String(p.valor_realizado) : "",
          moeda: p.moeda || "BRL",
        ...
        <TabsContent value="tarefas" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">Tarefas vinculadas a este projeto.</p>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">Em breve: listagem e gestão de tarefas do projeto.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
